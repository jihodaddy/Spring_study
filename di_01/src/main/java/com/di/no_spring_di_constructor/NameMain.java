...
public class NameMain {
	...
	public static void main(String[] args) {
		// NameController에게 전달할 NameService 객체 생성
		NameService nameService = new NameService();
		
		//외부에서 NameContrller객체 생성해서 생성자를 통해 주입 (injection)
...
/*
	...
	NameContoller 클래스의 생성자에서 매개변수로 받아서 NameService 객체를
	멤버 변수에 넣어 초기화 하여 사용
	
	이렇게 생성자를 이용하여 핖요한 객체를 넣어 주는 (injection) 방법을
